...
data = pd.read_csv(r"C:\Users\Lenovo\Downloads\InClass_DataPreprocessing_datasets\ethnic diversity.csv")
data.dtypes
...
import pandas as pd
data = pd.read_csv(r"C:/Users/Lenovo/Downloads/InClass_DataPreprocessing_datasets/mtcars_dup.csv")
...
cars = pd.read_csv(r"C:/Users/Lenovo/Downloads/InClass_DataPreprocessing_datasets/Cars.csv")
...
df = pd.read_csv(r"C:/Users/Lenovo/Downloads/InClass_DataPreprocessing_datasets/ethnic diversity.csv")
df.dtypes
...
ds = df.iloc[:,[1,4,10,11]]
ds
ds.columns

df.Department.value_counts()

ds.var() # variance of numeric variables
ds.var() == 0
ds.var(axis = 0) == 0
...
import seaborn as sns
sns.countplot(data=df, x="Salaries")
...
feature_names = enc.get_feature_names_out(input_features=df.columns[2:])
...
df = pd.read_csv(r'C:/Users/Lenovo/Downloads/InClass_DataPreprocessing_datasets/modified ethnic.csv') # for doing modifications
...
education = pd.read_csv(r"C:/Users/Lenovo/Downloads/InClass_DataPreprocessing_datasets/education.csv")
...
data = pd.read_csv(r"C:/Users/Lenovo/Downloads/InClass_DataPreprocessing_datasets/mtcars.csv")
