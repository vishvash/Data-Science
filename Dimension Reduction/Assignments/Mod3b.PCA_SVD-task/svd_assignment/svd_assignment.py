# -*- coding: utf-8 -*-
"""
Created on Sun Mar 24 19:02:06 2024
...
components.columns = ['svd0', 'svd1', 'svd2', 'svd3', 'svd4']
...
final = pd.concat([df.Customer, svd_res.iloc[:, 0:4]], axis = 1)
final.columns = ['Customer', 'svd0', 'svd1', 'svd2', 'svd3']
final

# Scatter diagram
ax = final.plot(x = 'svd1', y = 'svd2', kind = 'scatter', figsize = (12, 8))
final[['svd1', 'svd2', 'Customer']].apply(lambda x: ax.text(*x), axis = 1)
