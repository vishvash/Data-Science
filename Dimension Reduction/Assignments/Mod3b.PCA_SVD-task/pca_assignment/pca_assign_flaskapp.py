# -*- coding: utf-8 -*-
"""
Created on Sun Mar 24 18:08:38 2024
...
def success():
    if request.method == 'POST' :
        ...
        pca_res = pd.DataFrame(model.transform(data1), columns = ['pc0', 'pc1', 'pc2', 'pc3', 'pc4', 'pc5', 'pc6', 'pc7'])
        final = pd.concat([data.Customer, pca_res], axis = 1)
        
        final.to_sql('insurance_pred_pca', con = engine, if_exists = 'replace', chunksize = 1000, index = False)
