...
sentence6 = sentence5.replace('th', '')
wp_tokenizer = WordPunctTokenizer()
wp_tokenizer.tokenize(sentence5)
wp_tokenizer.tokenize(sentence6)



# Stemming
# Regexp Stemmer
sentence6 = "I love playing Cricket. Cricket players practice hard in their inning"
...
# en_blob.translate(from_lang = 'es', to = 'en')  #depricated 
...
translation = translator.translate("Bonjour le monde!", dest='en')
translation.text
...
cosine_similarity(np.asarray(tfidf_results[0]), np.asarray(tfidf_results[1]))

#cosine similarity between texts of pair2
cosine_similarity(np.asarray(tfidf_results[2]), np.asarray(tfidf_results[3]))

#cosine similarity between texts of pair3
cosine_similarity(np.asarray(tfidf_results[4]), np.asarray(tfidf_results[5]))
