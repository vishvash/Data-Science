...
def name_email(name, email):
    print(f'you name is {name} and your email is {email}') 

name_email("vishva","a@gmail.com")
...
# Usage
greet(name='Vishva', age=20)
greet()

def def_arg(id, dept = "mech"):
    print(f"The id is {id} and the dept is {dept}")
def_arg(123)

def kw_arg(id, dept):
    print(f"The id is {id} and the dept is {dept}")
kw_arg(id = 234, dept ="ece")
