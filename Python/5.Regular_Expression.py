...
txt = "Cats and dogs are cute."

# Find all occurrences of "and" that are not at word boundaries
pattern = r'\Band\B'
...
a = "@at. bat athen at- _at_ at"
pattern = r'\bat\b' 
b = re.findall(pattern, a)
print(b)

a = "@at. bat mathen gather athen late at- _at_ at"
pattern = r'\Bat\B' 
b = re.findall(pattern, a)
print(b)
