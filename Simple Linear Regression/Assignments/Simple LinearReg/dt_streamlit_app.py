...
def predict_AT(data,user,pw,db):
    ...
    final.to_sql('dt_predictons', con = engine, if_exists = 'replace', chunksize = 1000, index= False)
...
def main():
    st.title("Delivery_Time prediction")
    st.sidebar.title("Fuel Efficiency prediction")
    
    html_temp = """
    <div style="background-color:tomato;padding:10px">
    <h2 style="color:white;text-align:center;">Delivery_Time prediction ML App </h2>
    </div>
    """
